      ...
      <div className="dashboard-container">
        <div className="profile-container">
          ...
          <p>
            ...
            consequuntur itaque vel magnam dignissimos rem rerum. Praesentium?
          </p>
        ...
        <div className="extra-container">
          <h1>About User</h1>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod, perferendis soluta cumque adipisci pariatur recusandae?</p>
          
          <div className="today-earning">
            <div className="amount">$92</div>
            <div className="earing-label">Todays's Earning</div>
          </div>

          <div className="weekly-earning">
            <div className="amount">$651</div>
            <div className="earing-label">Weekly Earning</div>
          </div>
